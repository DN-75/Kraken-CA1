      ...
      <main className="relative  overflow-x-hidden ">
        ...
        <section className="gsap-hero-section relative z-[2] min-h-[600px] md:max-lg:min-h-[520px] max-sm:min-h-[480px] max-[400px]:min-h-[420px] flex flex-col items-center justify-center text-center py-[60px] px-5 pt-[80px] md:max-lg:pt-[70px] md:max-lg:pb-[48px] max-sm:py-[40px] max-sm:px-4 max-sm:pt-[60px] max-[400px]:py-[32px] max-[400px]:px-3 max-[400px]:pt-[48px] overflow-hidden">
          ...
          <div className="relative z-[1] max-w-[700px] w-full">
            <h1 className="gsap-hero-title text-5xl lg:max-xl:text-[2.5rem] md:max-lg:text-[2.2rem] max-sm:text-[2rem] max-[400px]:text-[1.65rem] font-extrabold leading-[1.15] mb-5 text-white">
              1-on-1 Experts Guidance
              <br className="max-sm:hidden" />
              for Your <span className="text-[var(--emerald-primary)]">Growth</span>
            </h1>

            <p className="gsap-hero-subtitle text-[0.95rem] max-sm:text-[0.88rem] md:max-lg:text-[0.9rem] text-white/65 leading-[1.7] max-w-[520px] md:max-lg:max-w-[420px] max-sm:max-w-full mx-auto mb-8">
            ...
            {/* Category tags */}
            <div className="gsap-hero-tags flex flex-wrap justify-center gap-2.5 max-sm:gap-2 max-[400px]:gap-1.5 mt-2">
              {CATEGORIES.map((cat) => (
                <Link
                  key={cat}
        ...
        <div className="relative">
          ...
          {/* ═══ Why Choose ═════════════════════════════════ */}
          <section className="gsap-why-section relative z-[1] py-20 md:max-lg:py-14 max-sm:py-12 px-5 max-sm:px-4 text-center">
            <div className="gsap-why-header">
            ...
            <div className="gsap-why-cards-container grid grid-cols-[repeat(auto-fit,minmax(260px,1fr))] max-sm:grid-cols-1 md:max-lg:grid-cols-2 gap-6 md:max-lg:gap-[18px] max-sm:gap-4 max-w-[900px] lg:max-xl:max-w-[700px] md:max-lg:max-w-full max-sm:p-0 md:max-lg:px-2 mx-auto"
              style={{
            ...
            >
              {FEATURES.map((f) => (
                <div
                  key={f.title}
                  className="gsap-why-card bg-[var(--card-bg)] border border-[var(--card-border)] rounded-2xl p-9 px-7 md:max-lg:p-7 md:max-lg:px-[22px] max-sm:p-6 max-sm:px-5 text-left transition-all duration-[250ms] hover:-translate-y-1 hover:shadow-[0_12px_40px_rgba(16,185,129,0.08)]"
                >
          ...
          {/* ═══ Top Rated Mentors ══════════════════════════ */}
          <section className="gsap-mentors-section relative z-[1] py-20 md:max-lg:py-14 max-sm:py-12 px-5 max-sm:px-4">
            <div className="gsap-mentors-header max-w-[900px] mx-auto mb-12 md:max-lg:mb-9 md:max-lg:text-center max-sm:mb-7 max-sm:text-center"
            >
            ...
            <div className="gsap-mentors-cards-container grid grid-cols-[repeat(auto-fit,minmax(260px,1fr))] md:max-lg:grid-cols-2 max-sm:grid-cols-1 gap-6 md:max-lg:gap-[18px] max-sm:gap-4 max-w-[900px] lg:max-xl:max-w-[700px] md:max-lg:max-w-full max-sm:p-0 md:max-lg:px-2 mx-auto"
              style={{
                backdropFilter: "blur(15px)",
                WebkitBackdropFilter: "blur(15px)",
              }}
            >
              {error ? (
                ...
                topProfessionals.map((professional) => (
                  <div key={professional.id} className="gsap-mentor-card">
          ...
          {/* ═══ About Us ════════════════════════════════════ */}
          <section id="about" className="gsap-about-section relative z-[1] py-14 md:max-lg:py-10 max-sm:py-9 px-5 max-sm:px-4">
            <div className="gsap-about-header text-center mb-8">
            ...
            <div className="gsap-about-cards-container max-w-[820px] lg:max-xl:max-w-full md:max-lg:max-w-full mx-auto grid grid-cols-3 md:max-lg:grid-cols-2 max-sm:grid-cols-1 gap-3.5 max-sm:gap-3">
              {/* Mission card - large */}
              <div className="gsap-about-card col-span-full relative rounded-[18px] border border-[var(--card-border)] bg-gradient-to-br from-[rgba(6,60,40,0.7)] to-[rgba(2,28,20,0.9)] p-7 max-sm:p-[18px] md:max-lg:p-[22px] pb-6 overflow-hidden"
                style={{
                  backdropFilter: "blur(15px)",
                  WebkitBackdropFilter: "blur(15px)",
                }}
              ...
              {ABOUT_HIGHLIGHTS.map((item) => (
                <div
                  key={item.title}
                  className="gsap-about-card about-bento-card rounded-2xl border border-[var(--card-border)] bg-[var(--card-bg)] p-[22px] px-5 max-sm:p-[18px] max-sm:px-4 transition-all duration-300 relative overflow-hidden hover:border-[rgba(16,185,129,0.35)] hover:-translate-y-[3px]"
                  style={{
                    backdropFilter: "blur(15px)",
                    WebkitBackdropFilter: "blur(15px)",
                  }}
              ...
              {/* Stats strip */}
              <div className="gsap-about-card col-span-full flex flex-wrap items-center justify-center gap-7 md:max-lg:gap-[18px] max-sm:gap-4 rounded-2xl border border-[var(--card-border)] bg-[linear-gradient(90deg,rgba(6,60,40,0.4),rgba(16,185,129,0.06),rgba(6,60,40,0.4))] py-5 px-6 max-sm:p-4 "
                style={{
                  backdropFilter: "blur(15px)",
                  WebkitBackdropFilter: "blur(15px)",
                }}
          ...
          {/* ═══ Contact Us ══════════════════════════════════ */}
          <section id="contact" className="gsap-contact-section relative z-[1] py-12 md:max-lg:py-10 max-sm:py-9 px-5 max-sm:px-4">
            <div className="gsap-contact-card relative max-w-[750px] lg:max-xl:max-w-full md:max-lg:max-w-full mx-auto rounded-[20px] border border-[var(--card-border)] bg-[var(--card-bg)] backdrop-blur-[12px] p-8 px-7 pb-7 max-sm:p-5 max-sm:px-4 md:max-lg:p-6 md:max-lg:px-5 overflow-hidden"
              style={{
                backdropFilter: "blur(15px)",
                WebkitBackdropFilter: "blur(15px)",
              }}
